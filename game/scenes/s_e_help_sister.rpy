...
label .shot1:
    if sister_request_phase == 1:
        ...
        "\"hey sis could you translate that for me? Thx\" followed by a short, ambiguous Japanese sentence, out of context.\""
...
label .shot2:
    menu:
        ...
        "I give a fake translation to remind her I'm busy.":
            $ sister_request_reply = "fake translation"
            "I reply it means \"Don't bother your sister with random requests.\""
        "I don't." if sister_request_phase == 1:
            $ sister_request_reply = "silence"
            "I just ignore the message."
        "I still don't." if sister_request_phase == 2:
            $ sister_request_reply = "silence"
...
label .shot3:
    ...
    if sister_request_reply == "ask context":
        "\"it's about a man hired to prevent a detective from investigating on embezzlement\""
    ...
    if sister_request_reply == "fake translation":
        "\"ahaha... no seriously what does that mean??\""
        "Hmpf."
        call .shot2 from _call_s_e_shot2_1
    if sister_request_reply == "silence":
        "\"I know you've read my msg it's showing on the app!\""
        "Urg..."
