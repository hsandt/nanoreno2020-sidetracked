...
define gui.idle_small_color = '#744675'

## The color that is used for buttons and bars that are hovered.
define gui.hover_color = '#f4cfe5'
...
define gui.insensitive_color = '#f4cfe5'

## Colors used for the portions of bars that are not filled in. These are not
## used directly, but are used when re-generating bar image files.
define gui.muted_color = '#bd8cbe'
define gui.hover_muted_color = '#9e649f'
...
define gui.choice_button_text_idle_color = "#744675"
